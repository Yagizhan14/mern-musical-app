    ...
    <div className='playlist-page'>
      <div className='player'>
        <div className='player-song-cover'>
          ...
          <h4 className='player-song-title' ref={songTitleRef}>
        ...
        <div className='player-controls'>
          <div className='control-buttons'>
            ...
            <button className='play-pause-button' onClick={playOrPauseSong}>
              <i className='fas fa-play'></i>
              <i style={{ display: 'none' }} className='fas fa-pause'></i>
            </button>
        ...
        <audio
          src={require(`../audio/${playlistSongs[currentSong]}.mp3`)}
          ref={player}
    ...
    <div className='no-songs-found'>
      <div className='no-songs-description'>
        ...
        <div className='no-songs-text'>
          ...
          <p>
            You can add songs into your playlist by clicking the button below.
          </p>
        </div>
      </div>
